...
public class FileQuadSource implements IQuintSource {
    ...
    private MyTripleStore myTripleStore;
    private List<IQuint> quints = new ArrayList<>();
    /**
     * Constructor
     *
...
//        listeners = new ArrayList<>();
        ...
        this.myTripleStore = new MyTripleStore();
    ...
    @Override
    public void close() {
        logger.info("Source Closed, uploaded " + counter + " quints");
...
//            i.sourceStarted();
        ...
        while (paths.hasNext()) {
            ...
            try {
                ...
                myTripleStore.addQuints(quints);
                // Close stream
                in.close();
